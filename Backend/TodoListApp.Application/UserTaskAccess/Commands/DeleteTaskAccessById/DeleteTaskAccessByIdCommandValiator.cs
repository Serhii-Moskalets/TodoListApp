...
/// </summary>
public class DeleteTaskAccessByIdCommandValiator : AbstractValidator<DeleteTaskAccessByIdCommand>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="DeleteTaskAccessByIdCommandValiator"/> class
    ...
    /// </param>
    public DeleteTaskAccessByIdCommandValiator(IUnitOfWork unitOfWork)
    {
